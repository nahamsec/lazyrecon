...
master_report()
{
  ...
  echo "   <div clsas=\"row\">" >> ./$1/$foldername/master_report.html
  ...
  echo "<span style='background-color:#00f93645;'><a href='https://$nline'>$nline</a></span>" >> ./$1/$foldername/master_report.html
